            ...
            if faces is not ():
                ...
                for i, face in enumerate(faces):
                    ...
                    label = "{}, {}".format(int(predicted_ages[i]),
                                            "Female" if predicted_genders[i][0] > 0.2 else "Male")
                    FaceFileName = str(int(predicted_ages[i])) + "_{}_" .format("F" if predicted_genders[i][0] > 0.2 else "M")+ str((now.strftime("%Y%m%d%H%M%S"))) + ".jpg"
